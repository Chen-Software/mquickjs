...
#include <stdlib.h>
#include <stdio.h>
#include "build/microquickjs.h"
#include "mquickjs.h"
#include "mquickjs_priv.h"

// Forward declaration of cabi_realloc (provided by microquickjs.c)
void *cabi_realloc(void *ptr, size_t old_size, size_t align, size_t new_size);

/* Standard library function stubs used in mqjs_stdlib.h */
...
JSValue js_load(JSContext *ctx, JSValue *this_val, int argc, JSValue *argv) { return JS_ThrowInternalError(ctx, "load() not supported"); }
JSValue js_setTimeout(JSContext *ctx, JSValue *this_val, int argc, JSValue *argv) { return JS_ThrowInternalError(ctx, "setTimeout() not supported"); }
